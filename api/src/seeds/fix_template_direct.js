...
// Config dotenv manually because we are running from a subfolder or root
dotenv.config({ path: "../../.env" });
// If running from root: .env
// If running from api/src/seeds: ../../../.env
...
const fixTemplate = async () => {
    try {
      ...
      `,
        ...
        console.log("✅ Template 'email_verification' saved!");
        process.exit(0);
    } catch (error) {
