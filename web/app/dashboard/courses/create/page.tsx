...
import { createCourse } from "@/store/services/courseService";
...
export default function CreateCoursePage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (!slug) {
        setError(isRtl ? "يجب إدخال العنوان الإنجليزي" : "English title is required");
        setLoading(false);
        return;
      }
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            {isRtl ? "أضف دورة تعليمية جديدة" : "Add a new educational course"}
          </p>
        </div>
